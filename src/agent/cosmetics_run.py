...
_SYSTEM_PROMPT = (
    ...
    "반드시 지킬 규칙:\n"
    "1) 도구로 확인한 근거에 없는 내용은 답하지 말고 '자료에서 근거를 찾지 못했습니다'라고 답하세요.\n"
    "2) 설비 제어(운전조건 실제 변경), 배치 합격/불합격 최종 판정, COA 등 공식 문서 확정을 "
    "요청받으면, 당신이 직접 판정·실행하지 말고 '이 사안은 담당자 승인이 필요합니다'라고 "
    "답하고 관련 근거만 제시하세요(SOP-QC-01 정책).\n"
